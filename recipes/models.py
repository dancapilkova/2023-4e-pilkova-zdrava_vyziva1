...
DAY_TIME = (("breakfast", "Breakfast"), ("snack", "Snack"), ("lunch", "Lunch"), ("dinner", "Dinner"))
...
class Recipe(models.Model):
    ...
    image = ResizedImageField(size=[400, None], quality=75, upload_to="recipes/", force_format="WEBP", blank=False, null=False,)
